 ...
 * <br>Description:   全局持久cookie,保存本地每次都会携带在header中
 * <br>Alter By:
 */
public class PersistentCookieStore implements CookieStore {
    ...
    public PersistentCookieStore(Context context) {
        ...
        if (!StringUtils.checkNull(TokenCache.getToken())) {
            HttpCookie cookie = new HttpCookie(TOKEN_NAME, TokenCache.getToken());
    ...
    protected String encodeCookie(SerializableHttpCookie cookie) {
        ...
        try {
            ...
            //LogUtil.debug(LOG_TAG, "IOException in encodeCookie" + e.toString());
            return null;
        }
    ...
    protected HttpCookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            //LogUtil.debug(LOG_TAG, "IOException in decodeCookie" + e.toString());
        } catch (ClassNotFoundException e) {
            //LogUtil.debug(LOG_TAG, "ClassNotFoundException in decodeCookie" + e.toString());
        }
